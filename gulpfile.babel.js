// Generated on 2017-02-19 using generator-angular-fullstack 4.1.3
'use strict';
...
const paths = {
    client: {
        ...
        styles: [`${clientPath}/{app,components,directives}/**/*.scss`],
                ...
                .pipe(plugins.sort()),
            {
                transform: (filepath) => {
                    let newPath = filepath
                        ...
                        .replace(`/${clientPath}/directives/`, '../directives/')
